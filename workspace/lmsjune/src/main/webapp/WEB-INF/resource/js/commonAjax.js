...
function selectcombo(comtype, combo_name, type, selvalue){
	...
	$.ajax({ 
	     ...
	     { 				
	         ...
	         { 		
	        	 ...
	        	 if(selvalue != null && selvalue != null && selvalue != "") {
	        		 if(selvalue == item_obj.cd) {
	        			 //console.log(" comtype selvalue item_obj.cd : " + comtype + " : " + item_obj.cd);
	        		 ...
	        		 //console.log(" comtype item_obj.cd : " + comtype + " : " + item_obj.cd);
	        		 $(selectbox).append("<option value='"+ item_obj.cd + "'>" + item_obj.name + "</option>");
	        	 }
