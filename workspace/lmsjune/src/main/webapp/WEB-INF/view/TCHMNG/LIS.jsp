...
<script type="text/javascript">
	...
	function RegisterCom(data) {
	     ...
	     if(confirm("등록하시겠습니까?")){
	         ...
	         callAjaxFileUploadSetFormData("/TCH/addLecturePro.do", "post", "json", true, dataWithFile, resultCallback);
	      }else {
	            return;
	     }
   }
		...
		<div id="container">
			<ul>
					...
					<colgroup>
						...
						<tbody>
							...
							<tr id="birthday1">
								...
								<td>
								       <input type="date" class="inputTxt p100"		name="lec_end" id="lec_end" style="font-size: 15px" />
							</tr>
							<tr>
				...
				<div class="btn">
							...
							<a class="btnType gray"  href="" id="ResetCom" name="btn"><span>취소</span></a>
				</div>
