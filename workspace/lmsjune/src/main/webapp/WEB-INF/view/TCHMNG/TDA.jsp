...
<script type="text/javascript">
	...
	function board_search(currentPage) {
        ...
        callAjax("/TCH/listLec.do", "post", "text", true, param, resultCallback);
	...
	//강의번호로 강의계획서 불러오기?이거되나?
	function planDetail(lec_no) {
		
		var param = {
			lec_no : lec_no
		}
		var resultCallback = function(data) {
			console.log("oooooooooo>>lec_no<<ooooooooo : " + JSON.stringify(data));
			planDetailResult(data);
		}
		
		callAjax("/TCH/planDetail.do", "post", "text", true,param, resultCallback);
	}
	
	function planDetailResult(data) {
		 console.log("planDetailResult : " + data);
  ...
  function filedownload(lec_no) {
	   var params = "<input type='hidden' name='lec_no' value='"+ lec_no +"' />";
    	jQuery("<form action='/TCH/downloadfile.do' method='post'>"+params+"</form>").appendTo('body').submit();
    } 
							...
							<table class="col">
								...
								<thead>
									<tr>
										...
										<th scope="col">강의명</th>
										<th scope="col">자료명</th>
										<th scope="col">자료내용</th>
										<th scope="col">자료파일</th>
									</tr>
								</thead>
								</table>
