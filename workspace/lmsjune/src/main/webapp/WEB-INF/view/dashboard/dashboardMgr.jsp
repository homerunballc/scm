...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			selectcombo("room", "room", "all", "");   // tea : 교수   room : 강의실  course : 과정 , Combo Name, Option("all" : 전체     "sel" : 선택 , Select Value )  
	...
	function fListInfResult(data, currentPage) {
	 ...
	 function fListLecture(currentPage) {
		...
		//alert(" slec : " + selectLecture.slec + " stea : " + selectLecture.stea );
    ...
    function fselecrlecResult(data) {
		...
		/* 
		data.lecinfo.lec_no;
		data.lecinfo.teach_no;
		data.lecinfo.name;
		data.lecinfo.lec_name;
		data.lecinfo.room_no;
		data.lecinfo.room_name;
		data.lecinfo.lec_start;
		data.lecinfo.lec_end;
		data.lecinfo.lec_cnt;
		data.lecinfo.std_cnt;
		 */
