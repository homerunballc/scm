...
import kr.happyjob.study.system.service.SelectComboService;
...
public class CommonProc {
	...
	@ResponseBody
	public  Map<String,Object> selectcombo(Model model, 
		...
		String type = (String) paramMap.get("comtype");
		
		List<comcombo> list = new ArrayList<>();
		
		if("course".equals(type)) {
		    list = selectComboService.selectcourselist(paramMap);
		} else if("room".equals(type)) {
			list = selectComboService.selectroomlist(paramMap);
		} else if("tea".equals(type)) {
			list = selectComboService.selecttealist(paramMap);
		}
		
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("list", list);
		
		logger.info("+ selectcombo End " + className + " : " + list.size());
