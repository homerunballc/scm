...
public interface DashboardDao {
	...
	public void insertlec(Map<String, Object> paramMap) throws Exception;
	
	public void updatelec(Map<String, Object> paramMap) throws Exception;
	
	public void deletelec(Map<String, Object> paramMap) throws Exception;
