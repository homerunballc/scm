				...
				<tr>
						...
						<td>
						     <c:if test="${list.confirmYN eq null }">
                                 <a class="btnType3 color1" href="javascript:fRefundOne('${list.returnId}','Y');"><span>승인</span></a>
                                 <a class="btnType3 color1" href="javascript:fRefundOne('${list.returnId}','N');"><span>반려</span></a>
                             </c:if>    
