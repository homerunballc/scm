		...
		<div id="area-right" class="bts">
			...
			<table>
				...
				<tr>
					...
					<td>제품가격</td>
					<td><input type="text" class="form-control" value='<c:if test="${not empty info}">${info.price}</c:if>' name="price" id="price"></td>
				</tr>
				
				<tr>
					<td colspan="4">
						<textarea type="text" name="info" id="dtInfoArea" rows="3" class="form-control" style="width:100%; text-align:left;">
